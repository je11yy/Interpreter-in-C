...
status solve_expression(Trie_ptr trie, char * expression, uint32_t * result, int input_base, int output_base, int assign_base);
status scan_buffer(Trie_ptr trie, char * buffer, int input_base, int output_base, int assign_base);
